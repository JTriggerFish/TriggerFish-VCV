...
const std::array<ParameterDescriptor, MembraneParameterCount> Descriptors{{
    ...
    {"fundamental_hz", "Fundamental", "Hz", 25.f, 500.f, 105.f, Scale::Logarithmic},
    ...
    {"tension_decay_seconds", "Tension recovery", "s", .005f, 2.f, .13f, Scale::Logarithmic},
    {"contact_level", "Contact level", "x", 0.f, 3.f, .7f},
    {"contact_duration_seconds", "Contact width", "s", .0002f, .08f, .004f, Scale::Logarithmic},
    ...
    {"high_cut_hz", "Low-pass", "Hz", 500.f, 22000.f, 18000.f, Scale::Logarithmic},
    {"colour_frequency_hz", "Radiation colour", "Hz", 40.f, 20000.f, 2800.f, Scale::Logarithmic},
    {"colour_gain_db", "Radiation colour gain", "dB", -24.f, 24.f, 0.f},
    {"band_1_frequency_hz", "Band 1 frequency", "Hz", 30.f, 500.f, 90.f, Scale::Logarithmic},
    {"band_1_gain_db", "Band 1 gain", "dB", -24.f, 24.f, 0.f},
    {"band_2_frequency_hz", "Band 2 frequency", "Hz", 100.f, 2000.f, 350.f, Scale::Logarithmic},
    {"band_2_gain_db", "Band 2 gain", "dB", -24.f, 24.f, 0.f},
    {"band_3_frequency_hz", "Band 3 frequency", "Hz", 400.f, 8000.f, 1800.f, Scale::Logarithmic},
    {"band_3_gain_db", "Band 3 gain", "dB", -24.f, 24.f, 0.f},
    {"band_4_frequency_hz", "Band 4 frequency", "Hz", 1500.f, 20000.f, 7500.f, Scale::Logarithmic},
...
const ParameterDescriptor &MembraneParameterDescription(
...
tfdsp::percussion::MembraneDrumParameters ApplyMembraneParameters(
    const MembraneParameterValues &values) noexcept {
  ...
  controls.equalizerMode = static_cast<tfdsp::percussion::ObservationEqualizerMode>(
  ...
  constexpr std::array<P, 4> frequencies{
      P::Band1FrequencyHz, P::Band2FrequencyHz,
      P::Band3FrequencyHz, P::Band4FrequencyHz};
  constexpr std::array<P, 4> gains{
      P::Band1GainDb, P::Band2GainDb, P::Band3GainDb, P::Band4GainDb};
