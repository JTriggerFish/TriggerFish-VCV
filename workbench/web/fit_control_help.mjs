...
const ControlHelp = {
  ...
  bloom_energy_acceleration: "Makes bloom depend more on stored energy. Near zero, even quiet regions let the sound spread freely. Higher values can hold back the bloom until enough energy reaches them, while stronger strikes can spread faster. If the highs struggle to develop, try reducing this before raising Diffusion strength.",
