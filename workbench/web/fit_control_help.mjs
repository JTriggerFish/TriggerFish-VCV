...
const ControlHelp = {
  field_motion_depth: "Add irregular shimmer around each ringing pitch. Start gently; increase for a denser, more animated sound. Zero switches shimmer off. Unlike Pitch drift, this movement stays anchored around the original phase. Try it with Blur off to hear the difference.",
  field_motion_rate: "How quickly the shimmer changes: slow for breathing, faster for flutter and sizzle. Try 10–80 changes/s, or 80–200 for a finer texture. The movement is irregular, not a repeating vibrato. Needs Shimmer amount above zero.",
  ...
  field_turbulence: "How much of a ring near 1 kHz is spread into surrounding tones. Lower keeps a clear pitch; higher gives a fuller cluster. Bass / treble balance changes where those surrounding rings are strongest. Spread controls how far apart they are; Density controls how many there are.",
  ...
  field_wander_hz: "Let individual pitches drift gently out of tune and back. Try 0.3–1 Hz to make beating less clockwork; larger amounts give an audibly detuned sound. Can be combined with faster Shimmer. Zero switches pitch drift off.",
  field_wander_rate: "How often drifting pitches choose a new direction. Try 0.2–1 changes/s for slow, unhurried detuning. Each tone moves independently. Needs Pitch drift amount above zero.",
};
